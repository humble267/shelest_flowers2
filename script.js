  ...
  <header class="site-header">
    ...
    <div class="main-nav">
      <div class="container main-nav__inner">
        ...
        <a class="brand" href="${prefix}index.html" aria-label="(назва вашого магазину)">
          <img src="${prefix}images/logo.png" alt="Логотип (назва вашого магазину)" />
        </a>

        <div class="main-nav__content">
          <div class="main-nav__panel" id="site-menu">
            <div class="main-nav__panel-head">
              <p>(назва вашого магазину)</p>
  ...
  <footer class="site-footer">
    <div class="container site-footer__inner">
      ...
      <div class="site-footer__note">
        <p>Каталог (назва вашого магазину)</p>
...
const renderCatalogPage = async () => {
  ...
  try {
    ...
    document.title = `${getCategoryDisplayTitle(activeCategory)} | (назва вашого магазину)`;
...
const renderProductPage = async () => {
  ...
  try {
    ...
    document.title = `${product.name} | (назва вашого магазину)`;
...
const searchCatalog = [
  ...
  {
    title: "Про нас",
    description: "Історія, стиль і підхід (назва вашого магазину).",
